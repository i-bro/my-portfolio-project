...
export class Profile {
  ...
  renderAbout() {
    ...
    const colImg = ui.createElement(
      "div",
      "col-md-12 col-lg-6 col-sm-12 text-center mb-4 mb-md-0",
    );
    const img = ui.createElement(
      "img",
      "img-fluid rounded-circle shadow-lg about-img",
      "",
      {
